  ...
  public static getNodeUrls = (networkId: NetworkId) => {
    ...
    switch (networkId) {
      ...
      case NetworkId.TESTNET_KOVAN:
        return this._get({
          key: `REACT_APP_ETHEREUM_TESTNET_KOVAN_NODE_URL`,
          fallback: "https://kovan.infura.io/v3/d18f87039fa947c396337789209ef583",
        });
      case NetworkId.MAINNET_CRO:
        return this._get({
          key: `REACT_APP_ETHEREUM_TESTNET_CRONOS_NODE_URL`,
          fallback: "https://evm.cronos.org",
        });
      case NetworkId.TESTNET_CRO:
        return this._get({
          key: `REACT_APP_ETHEREUM_TESTNET_CRONOS_NODE_URL`,
          fallback: "https://evm-t3.cronos.org",
        });
